 ...
 static final String HOST = "localhost";
    ...
    public static void main(String[] args) {
        ...
        try (
            ...
            BufferedReader entrada = new BufferedReader( //lo que nos llega del servidor
            new InputStreamReader(socket.getInputStream()));
            PrintWriter salida = new PrintWriter(socket.getOutputStream(), true);//lo que mandamos al servidor
            Scanner teclado = new Scanner(System.in)
        ) {
            System.out.println("Conexión establecida!\n");
            
            //hilo dedicado a recibir mensajes del servidor
