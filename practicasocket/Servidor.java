...
public class Servidor {
    ...
    private static void manejarCliente(Socket socket) {
        try (
            ...
            salida.println("Bienvenido al Servidor de Cifrado!");
            salida.println("Comandos disponibles:");
            salida.println("  CRYPT <mensaje> -> Aplica el cifrado especial");
            ...
            System.err.println("[SERVIDOR] Error en la comunicación.");
        }
    }
    ...
    private static String procesarMensaje(String mensaje) {
        ...
        if (comando.equals("CRYPT")) {
            if (partes.length < 2 || partes[1].trim().isEmpty()) {
                return "ERROR: Debes escribir un texto.";
            }
